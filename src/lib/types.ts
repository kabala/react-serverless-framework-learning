...
export const NAVIGATION_AUTHENTICATION_FORGOT_PASSWORD =
  'NAVIGATION_AUTHENTICATION_FORGOT_PASSWORD';
export const NAVIGATION_AUTHENTICATION_CONFIRM_ACCOUNT =
...
`;
/* constant objects */
export const AUTHENTICATION_PWD_VALIDATION_REGEX =
  /^(?=.*[0-9])(?=.*[!@#$%^&*.])[a-zA-Z0-9!@#$%^&*.]{8,16}$/;
