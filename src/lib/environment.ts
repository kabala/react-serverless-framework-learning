...
export const USER_POOL_ID: string = process.env.REACT_APP_USER_POOL_ID!;
/* the pictures table name */
export const PICTURE_TABLE: string = process.env.REACT_APP_PICTURES_TABLE!;
/* the picture storage bucket name */
export const PICTURE_BUCKET: string = process.env.REACT_APP_PICTURES_BUCKET!;
/* the identity pool identifier, which provides access to AWS resources */
export const IDENTITY_POOL_ID: string = process.env.REACT_APP_IDENTITY_POOL_ID!;
/* the user pool client identifier which provides access to using the SDK */
export const USER_POOL_CLIENT_ID: string = process.env.REACT_APP_USER_POOL_CLIENT_ID!;
